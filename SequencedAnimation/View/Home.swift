...
//  SequencedAnimation
//
//  Created by David Santiago on 6/11/22.
//
...
struct Home: View {
    ...
    @State var animateContext: Bool = false
    ...
    var body: some View {
        VStack(spacing: 15) {
            ...
            CardView(cardColor: Color("OrangeColor"), spent: "7821.25", cardNumber: "9813", cardIndex: 1)
        }
        .padding(15)
        ...
        .overlay(alignment: .topTrailing) {
            Button {
                ...
                Text("Due")
                    ...
                    .underline(true, color: Color("OrangeColor"))
            }
            .padding(15)
            .offset(x: startAnimation ? 0 : -100)
            .opacity(startAnimation ? 1 : 0)
    ...
    // MARK: Card View
    // Both Cards Animating At Same Time, With the Help of Index We can Slow Down the Sub Sequent Cards Animating Timing
    @ViewBuilder
